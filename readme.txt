...
Tags: admin, bar, hello bar, hello, stats, hellos bar
...
This plugin adds a jQuery file that will position a fixed bar at the top of your browser screen to show announcements (controlled by a custom post type [CPT]) on each page load. Built with simple HTML and javascript. Please note that this plugin is in no way affiliated with the [Hello Bar](http://www.hellobar.com) service.
...
For question please visit my blog @ [http://austinpassy.com](http://austinpassy.com/wordpress-plugins/hellos-bar/)
...
<del>This plugin is still under **&alpha;**lpha testing, and may have some bugs.</del>
...
3. Go to Hellos Bar settings to edit your settings.
...
* `post_type` **hellobar** incorect on post-type.php.
